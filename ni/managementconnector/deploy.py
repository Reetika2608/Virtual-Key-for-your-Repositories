...
from ni.managementconnector.platform.http import Http, CertificateExceptionFusionCA, CertificateExceptionNameMatch, \
    CertificateExceptionInvalidCert
from ni.managementconnector.config.managementconnectorproperties import ManagementConnectorProperties
from ni.managementconnector.cloud.oauth import OAuth
from ni.managementconnector.service.service import ServiceException
from ni.managementconnector.service.servicedependency import ServiceDependency
from ni.managementconnector.service.servicemanager import ServiceManager
...
class Deploy(object):
    ...
    def _process_stopped_alarm(self, stopped_connectors, alarm_id, msg):
        ...
        if len(stopped_connectors) == 0:
            ...
            for connector in stopped_connectors:
                desc_line = ni.utils.i18n.translate(msg) % (str(connector))
