...
class System(object):
    ...
    def am_i_clustered():
        ...
        rest_database_client = restclient.ClusterDatabaseRestClient()
    ...
    def am_i_master():
        ...
        try:
            api = XMLAPIConfigurationManager()
            this_peer = api.get_local_cluster_peer_position()
            master = api.get_configuration_master()
