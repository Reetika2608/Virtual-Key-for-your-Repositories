...
from ni.managementconnector.service.connectorservice import ConnectorService
from ni.managementconnector.service.servicedependency import ServiceDependency
...
class ServiceManager():
    ...
    def _process_enable_alarm(self, failed_config, alarm_id, msg):
        ...
        if(len(failed_config) == 0):
            ...
            for config in failed_config:
                desc_line = ni.utils.i18n.translate(msg) % (str(config['display_name']))
    ...
    def _process_upgrade_alarm(self, failed_config, alarm_id, msg):
        ...
        if(len(failed_config) == 0):
            ...
            for config in failed_config:
                desc_line = ni.utils.i18n.translate(msg) % (str(config['display_name']), str(config['url']))
                description_text = description_text + desc_line + "\n"
    ...
    def _process_version_alarm(self, failed_config, alarm_id, msg):
        ...
        if len(failed_config) == 0:
            ...
            for config in failed_config:
                desc_line = ni.utils.i18n.translate(msg) % (str(config['display_name']), str(config['version']),
    ...
    def _process_unknownhost_alarm(self, failed_config, alarm_id, msg):
        ...
        if(len(failed_config) == 0):
            ...
            for config in failed_config:
                ...
                desc_line = ni.utils.i18n.translate(msg) % (url, str(config['display_name']))
                description_text = description_text + desc_line + "\n"
