...
import ni.managementconnector.platform.http as http
import ni.managementconnector.config.config as config
...
class HTTPTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.platform.http.Http._config.read')
    @mock.patch('ni.managementconnector.platform.http.uuid.uuid4')
    ...
    @mock.patch('ni.managementconnector.platform.http.ManagementConnectorProperties')
    @mock.patch('ni.managementconnector.platform.http.taacrypto.decrypt_with_system_key')
    @mock.patch('ni.managementconnector.platform.http.Http._config.read')
    ...
    @mock.patch('ni.managementconnector.platform.http.Http.get_proxy')
