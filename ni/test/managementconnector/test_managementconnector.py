...
class ManagementConnectorTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.platform.logarchiver.LogArchiver.push_logs_async')
    @mock.patch('ni.managementconnector.managementconnector.WatchdogThread')
    @mock.patch('ni.managementconnector.managementconnector.FeatureThread')
    @mock.patch('ni.managementconnector.managementconnector.ManagementConnector.toggle_features')
    @mock.patch('ni.managementconnector.managementconnector.U2CThread')
    @mock.patch('ni.managementconnector.managementconnector.MercuryRunner')
    @mock.patch('ni.managementconnector.managementconnector.MachineAccountRunner')
    @mock.patch('ni.managementconnector.platform.serviceutils.CafeXUtils.is_package_installing')
    @mock.patch('ni.managementconnector.managementconnector.ServiceUtils.request_service_change')
    @mock.patch('ni.managementconnector.managementconnector.CAFEManager')
    @mock.patch('ni.managementconnector.managementconnector.Deploy')
    @mock.patch('ni.managementconnector.managementconnector.Config')
    ...
    @mock.patch('ni.managementconnector.managementconnector.os.listdir')
    @mock.patch('ni.managementconnector.managementconnector.os.path.getsize')
    @mock.patch('ni.managementconnector.managementconnector.ManagementConnectorProperties.is_fusion_certs_added')
    @mock.patch('ni.managementconnector.managementconnector.CAFEManager')
    @mock.patch('ni.managementconnector.managementconnector.Deploy')
    @mock.patch('ni.managementconnector.managementconnector.Config')
    @mock.patch('ni.managementconnector.managementconnector.jsonhandler')
    @mock.patch('ni.managementconnector.managementconnector.merge_certs')
