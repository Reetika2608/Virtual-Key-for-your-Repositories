...
class MetricsTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.cloud.metrics.Http')
    @mock.patch('ni.managementconnector.service.service.Service')
    @mock.patch('ni.managementconnector.cloud.metrics.ServiceUtils')
    @mock.patch('ni.managementconnector.cloud.metrics.ManagementConnectorProperties.get_utc_time', side_effect=get_current_time)
    ...
    @mock.patch('ni.managementconnector.cloud.metrics.Http')
    @mock.patch('ni.managementconnector.cloud.metrics.ServiceUtils.get_version')
    @mock.patch('ni.managementconnector.service.service.Service')
    @mock.patch('ni.managementconnector.cloud.metrics.ManagementConnectorProperties.get_utc_time', side_effect=get_current_time)
