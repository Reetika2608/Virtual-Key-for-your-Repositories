...
from ni.managementconnector.lifecycle.machineaccountthread import MachineAccountThread
...
class MachineAccountThreadTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.Http.patch')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.taacrypto.decrypt_with_system_key')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.taacrypto.encrypt_with_system_key')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.MCAlarm')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.OAuth')
    ...
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.ManagementConnectorProperties.MACHINE_POLL_TIME_FAIL', 1)
    @mock.patch('ni.managementconnector.config.config.Config')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.Http.patch')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.taacrypto.decrypt_with_system_key')
    @mock.patch('ni.managementconnector.lifecycle.machineaccountthread.taacrypto.encrypt_with_system_key')
