...
class WatchdogTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.lifecycle.watchdog.jsonhandler.read_json_file')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.jsonhandler.get_last_modified')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.WatchdogThread.restart')
    @mock.patch('ni.managementconnector.platform.http.Http')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.OAuth')
    ...
    @mock.patch('time.sleep')
    @mock.patch('threading.Event')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.Metrics.send_watchdog_restart_metrics')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.jsonhandler.read_json_file')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.jsonhandler.get_last_modified')
    @mock.patch('ni.managementconnector.lifecycle.watchdog.WatchdogThread.restart')
    @mock.patch('ni.managementconnector.platform.http.Http')
