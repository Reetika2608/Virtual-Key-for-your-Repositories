...
class AtlasTest(unittest.TestCase):
    ...
    @mock.patch('ni.managementconnector.cloud.atlas.System')
    @mock.patch('ni.managementconnector.cloud.atlas.jsonhandler.read_json_file')
    @mock.patch('ni.managementconnector.service.service.Service')
    @mock.patch('ni.managementconnector.cloud.atlas.ServiceUtils.get_version', side_effect=get_version)
