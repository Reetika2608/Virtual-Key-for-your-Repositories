...
C_MGMT_FILE = '/opt/c_mgmt/bin/managementconnectormain.pyc'
__main__.__file__ = C_MGMT_FILE
sys.argv[0] = C_MGMT_FILE
import ni.managementconnector.managementconnectormain

ni.managementconnector.managementconnectormain.main()
EOF
