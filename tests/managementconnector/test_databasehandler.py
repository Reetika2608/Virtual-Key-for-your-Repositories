...
class DatabaseHandlerTest(unittest.TestCase):
    ...
    @mock.patch("managementconnector.config.databasehandler.DatabaseHandler.write_blob")
    @mock.patch("managementconnector.config.databasehandler.DatabaseHandler.read")
    ...
    @mock.patch("managementconnector.config.databasehandler.CafeXUtils.get_installed_connectors")
    ...
    @mock.patch('managementconnector.config.databasehandler.DEV_LOGGER.error')
    @mock.patch("managementconnector.config.databasehandler.CafeXUtils.get_installed_connectors")
    @mock.patch('managementconnector.config.databasehandler.register_default_loggers')
