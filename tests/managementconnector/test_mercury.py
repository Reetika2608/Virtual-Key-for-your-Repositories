...
class MercuryTest(fake_filesystem_unittest.TestCase):
    ...
    @mock.patch('managementconnector.cloud.mercury.Mercury._run_probe_timer')
    @mock.patch('managementconnector.cloud.mercury.threading.Thread')
    @mock.patch('managementconnector.cloud.mercury.websocket')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.write_json_file')
    @mock.patch('managementconnector.cloud.wdm.Http.post')
    @mock.patch('managementconnector.cloud.wdm.os.path.isfile')
    ...
    @mock.patch('managementconnector.cloud.mercury.websocket')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.write_json_file')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.read_json_file')
    @mock.patch('managementconnector.cloud.wdm.Http.put')
    @mock.patch('managementconnector.cloud.wdm.os.path.isfile')
    @mock.patch('managementconnector.cloud.mercury.Metrics.send_mercury_metrics')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.config.config.Config')
    ...
    @mock.patch('managementconnector.cloud.wdm.Http.create_tracking_id')
    @mock.patch('managementconnector.cloud.mercury.Http.get_proxy')
    @mock.patch('managementconnector.cloud.wdm.DeviceManager.register_with_wdm')
    @mock.patch('managementconnector.cloud.remotedispatcher.jsonhandler.delete_file')
    @mock.patch('managementconnector.cloud.wdm.Http.delete')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.config.config.Config')
    ...
    @mock.patch('managementconnector.cloud.wdm.time.time')
    @mock.patch('managementconnector.cloud.mercury.websocket')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.delete_file')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.read_json_file')
    @mock.patch('managementconnector.cloud.wdm.Http.put')
    @mock.patch('managementconnector.cloud.wdm.os.path.isfile')
    @mock.patch('managementconnector.cloud.mercury.Metrics.send_mercury_metrics')
    ...
    @mock.patch('managementconnector.cloud.remotedispatcher.RemoteDispatcher.get_remotedispatcher_url')
    ...
    @mock.patch('managementconnector.cloud.wdm.DeviceManager.refresh_with_wdm')
    @mock.patch('managementconnector.cloud.wdm.time.time')
    @mock.patch('managementconnector.cloud.mercury.websocket')
    @mock.patch('managementconnector.cloud.mercury.Metrics.send_mercury_metrics')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    ...
    def test_mercury_on_message(self, mock_handle, mock_config, mock_oauth, mock_alarm, mock_send_err):
        """
    ...
    @mock.patch('managementconnector.cloud.mercury.traceback.format_exc')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.config.config.Config')
    ...
    @mock.patch('managementconnector.cloud.mercury.websocket')
    @mock.patch('managementconnector.cloud.wdm.jsonhandler.read_json_file')
    @mock.patch('managementconnector.cloud.wdm.Http')
    @mock.patch('managementconnector.cloud.wdm.os.path.isfile')
    @mock.patch('managementconnector.cloud.wdm.time.time')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.config.config.Config')
    ...
    @mock.patch("cafedynamic.cafexutil.CafeXUtils.get_package_version")
    @mock.patch('managementconnector.cloud.mercury.Mercury.heartbeat')
    @mock.patch('managementconnector.cloud.mercury.Mercury.shutdown')
    ...
    @mock.patch('managementconnector.cloud.mercury.Mercury._run_probe_timer')
    @mock.patch('managementconnector.cloud.remotedispatcher.RemoteDispatcher.handle_command')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.config.config.Config')
