...
from managementconnector.service.service import Service, DisableException
...
class ServiceTest(fake_filesystem_unittest.TestCase):
    ...
    @mock.patch('managementconnector.service.service.CafeXUtils')
    ...
    @mock.patch('managementconnector.service.service.register_default_loggers')
    @mock.patch('managementconnector.service.service.ServiceUtils.cache_service_cdb_schema')
    @mock.patch("managementconnector.platform.system.System.get_system_mem")
    @mock.patch('managementconnector.service.service.ServiceUtils.is_supported_extension')
    @mock.patch('managementconnector.service.service.time')
    @mock.patch('managementconnector.service.service.EventSender.post')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.service.service.Service._download')
    @mock.patch('managementconnector.service.service.Service._install')
    @mock.patch('managementconnector.service.service.Service.uninstall')
    @mock.patch('managementconnector.service.service.Service.disable')
    @mock.patch('managementconnector.service.service.CafeXUtils')
    ...
    @mock.patch('managementconnector.service.service.DatabaseHandler')
    @mock.patch('managementconnector.service.service.register_default_loggers')
    @mock.patch('managementconnector.service.service.ServiceUtils.cache_service_cdb_schema')
    @mock.patch("managementconnector.platform.system.System.get_system_mem")
    @mock.patch('managementconnector.service.service.CafeXUtils')
    def test_disable(self, mock_cafeutils, mock_get_system_mem, mock_cache_service_cdb_schema, mock_register_default_loggers, mock_delete_enabled_service_blob):
        ...
        service = Service('c_xyz', Config(inotify=False), None)
    ...
    @mock.patch('managementconnector.service.service.ServiceUtils.cache_service_cdb_schema')
    @mock.patch("managementconnector.platform.system.System.get_system_mem")
    @mock.patch('managementconnector.service.service.EventSender')
    @mock.patch('managementconnector.cloud.oauth.OAuth')
    @mock.patch('managementconnector.service.service.ServiceUtils')
    ...
    def test_configure_prevent_connector(self, mock_cafeutils, mock_disable, mock_uninstall, mock_install, mock_download, mock_config, mock_serviceutils, mock_oath, mock_sender, mock_get_system_mem, mock_cache_service_cdb_schema, mock_register_default_loggers):
        service = Service('c_xyz', Config(inotify=False), mock_oath)
