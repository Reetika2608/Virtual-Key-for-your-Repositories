...
class ServiceUtilsTest(fake_filesystem_unittest.TestCase):
    ...
    @mock.patch('managementconnector.platform.serviceutils.jsonhandler')
    @mock.patch('managementconnector.platform.serviceutils.CafeXUtils')
    ...
    @mock.patch('managementconnector.platform.serviceutils.os')
    @mock.patch('managementconnector.platform.serviceutils.CafeXUtils')
    @mock.patch('managementconnector.platform.serviceutils.shutil')
    @mock.patch('managementconnector.platform.serviceutils.ServiceUtils.get_previous_versions')
    @mock.patch('managementconnector.platform.serviceutils.ServiceUtils.get_current_versions')
    ...
    @mock.patch('managementconnector.platform.serviceutils.System.get_tlp_filepath')
    ...
    @mock.patch('managementconnector.service.service.Service.get_suppressed_alarms')
    @mock.patch('managementconnector.service.service.Service.get_alarms')
    def test_get_suppressed_alarms(self, mock_alarms, mock_suppressed, mock_get_package_version, mock_get_system_mem):
        ...
        service = Service('c_mgmt', Config(inotify=False), None)
