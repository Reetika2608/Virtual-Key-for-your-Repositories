...
from tests_integration.utils.web_methods import create_web_driver, \
    ...
    create_screenshotting_web_driver, register_expressway, set_hybrid_proxy, create_screenshotting_retrying_web_driver, \
    is_in_page_source, run_iptables_script
...
class ProxyTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        run_iptables_script(cls.config.exp_hostname_primary(), cls.config.exp_root_user(), 
                            cls.config.exp_root_pass())

        
        set_hybrid_proxy(cls.config.exp_hostname_primary(), 
                         cls.config.exp_admin_user(), 
                         cls.config.exp_admin_pass(), 
                         cls.config.proxy_host(), 
                         cls.config.proxy_port(), 
                         cls.config.proxy_user(), 
                         cls.config.proxy_pass())
