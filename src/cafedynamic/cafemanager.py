...
from cafedynamic.cafecomponentconfig import CAFEComponentConfig
...
class CAFEManager(object):
    ...
    def _create_template_dir(self):
        ...
        try:
            CafeXUtils.make_path(CAFEProperties.get_component_template_dir())
        except OSError as ex:
            DEV_LOGGER.error(
    ...
    def _create_config_staging_dir(self):
        ...
        try:
            ...
            CafeXUtils.make_path(CAFEProperties.get_config_staging_dir())
        except OSError as ex:
            DEV_LOGGER.error(
