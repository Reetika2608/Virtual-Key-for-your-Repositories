...
class ServiceUtils(object):
    ...
    def get_alarms(service, prefix_link, permitted=True, include_suppressed=True):
        ...
        for alarm in alarm_list:
            ...
            title = translate("alm." + alarm['uuid'] + ".title")
            description = translate("alm." + alarm['uuid'] + ".description")
            ...
            solution = translate("alm." + alarm['uuid'] + ".solution")
            if solution.find('[[PRODUCT]]'):
                solution.replace('[[PRODUCT]]', translate("SYSTEM_TOKEN"))
