"""
This class will make the application handle for the Hybrid Services Logger available for xstatus and xcommand
This code will live in ni structure due to it's "X" touch points dependencies
"""
...
def initialise_hybrid_services_x_logging(application_name=None):
    """
